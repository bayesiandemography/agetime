...
#' - [age_levels_open_right()] Open age group levels on the right
#'
#' @examples
#' labels <- c("2020-2024", "<2000", "2015")
#' cohort_levels_open_left(labels, upper_open = 2020)
#' cohort_levels_open_left(labels, upper_open = 2005)
#' cohort_levels_open_left(c("2000-2004", "2010-2014"), upper_open = 1990)
#' @export

cohort_levels_open_left <- function(labels,
                                    upper_open,
